...
public class GlobalExceptionHandler {
	...
	public ResponseEntity<ErrorResponse> handlerMethodArgumentNotValidException(
		...
		ex.getBindingResult()
						.getAllErrors()
						.forEach(error -> {
							var fieldName = (error instanceof FieldError fe) ?
											fe.getField() :
											error.getObjectName();
	...
	public ResponseEntity<ErrorResponse> handleDataIntegrityViolationException(
		...
		return buildErrorResponseEntity(HttpStatus.CONFLICT, new RuntimeException("A data conflict occurred. Please check your input"), request);
	}
	...
	@ExceptionHandler(IllegalArgumentException.class) // TODO
	...
	public ResponseEntity<ErrorResponse> handleMaxUploadSizeExceededException(
		...
		return buildErrorResponseEntity(HttpStatus.PAYLOAD_TOO_LARGE, ex, request);
	}
